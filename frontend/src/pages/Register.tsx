...
export default function Register() {
  ...
  // Redirect connected users without profile to dashboard (global modal will handle registration)
  useEffect(() => {
    if (connected && !isLoading && !userRegistry) {
      navigate('/dashboard', { replace: true });
    }
  }, [connected, isLoading, userRegistry, navigate]);
  ...
  // Show registration wizard with dashboard background
  return (
    <div className="min-h-screen bg-gradient-to-br from-bg-primary via-bg-secondary to-bg-tertiary">
      <RegistrationWizard />
    </div>
